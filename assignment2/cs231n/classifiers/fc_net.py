    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers - 1):
            ...
            if self.normalization == None:
                ...
                if self.normalization == "batchnorm":
                    X, cache = affine_batchnorm_relu_forword(X, W, b, gamma, beta, bn_param)
                elif self.normalization == "layernorm":
                    X, cache = affine_layernorm_relu_forword(X, W, b, gamma, beta, bn_param)
            caches.append(cache)
            if self.use_dropout:
        ...
        for i in range(self.num_layers - 2, -1, -1):
            ...
            if self.normalization == None:
                ...
                if self.normalization == "batchnorm":
                    dout, dw, db, dgamma, dbeta = affine_batchnorm_relu_backword(dout, caches[i])
                elif self.normalization == "layernorm":
                    dout, dw, db, dgamma, dbeta = affine_layernorm_relu_backword(dout, caches[i])
